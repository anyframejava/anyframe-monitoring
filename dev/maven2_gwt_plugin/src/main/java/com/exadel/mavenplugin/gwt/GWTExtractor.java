      ...
      if (a.getGroupId().equals(getGroupId()) &&
        ...
        try {
          ...
          */
          ...
          System.out.println("Extraction dir: " + extractionDir);
          System.out.println("Artifact: " + a);
          System.out.println("Artifact file: " + a.getFile());
          System.out.println("Artifact file last modified: " + a.getFile().lastModified());
