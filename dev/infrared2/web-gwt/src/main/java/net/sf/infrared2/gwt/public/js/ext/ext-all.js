 ...
 */
/*
 * This file was modified comparing to original version of file from Ext JS Library v.2.0.1.
 * Change date: 23-May-2008
 * Checks on null were added into following functions:
 * 	fxUnwrap:function(A, C, B)
 * 	expandChildNodes:function(B)
 * 	refresh:function(B) (row 19311)
*/
...
Ext.Fx = {slideIn:function(A, C) {
    ...
    if (!B.wrap) {
        var p = A.dom.parentNode;
        if(p){
        	p.insertBefore(this.dom, A.dom);
        }
        A.remove()
    }
...
Ext.extend(Ext.Editor, Ext.Component, {value:"",alignment:"c-c?",shadow:"frame",constrain:false,swallowKeys:true,completeOnEnter:false,cancelOnEsc:false,updateEl:false,initComponent:function() {
    ...
    if (this.autoSize) {
        ...
        switch (this.autoSize) {case"width":this.setSize(D.width, "");break;case"height":this.setSize("", D.height);break;default:this.setSize(D.width, D.height)}
    }
...
Ext.tree.TreeNodeUI.prototype = {removeChild:function(A) {
    ...
    if (A) {
        ...
        this.node.attributes.checked = A.checked;
    }
},blur:function() {
    try {
        this.anchor.blur()
...
Ext.grid.PropertyColumnModel = function(C, B) {
    this.grid = C;
    var D = Ext.grid;
    D.PropertyColumnModel.superclass.constructor.call(this, [{header:this.nameText,width:50,sortable:true,dataIndex:"name",id:"name"},{header:this.valueText,width:50,resizable:false,dataIndex:"value",id:"value"}]);
    this.store = B;
